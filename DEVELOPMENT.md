...
**Namn på denna komponent:** `linux_updates`
...
```bash
ln -s /workspaces/homeassistcore/config/linux_updates/custom_components/linux_updates /workspaces/homeassistcore/config/custom_components/
```
...
```bash
unlink /workspaces/homeassistcore/config/custom_components/linux_updates
```
